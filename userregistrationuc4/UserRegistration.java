package com.day19.userregistrationuc1.userregistrationuc4;
...
public class UserRegistration {
    ...
    public static void validLastName() {
        ...
        String name = scanner.next();
        String regex = "^[A-Z]{1}[a-z]{2,}$"; //        name Start with caps Kolte ,and having 1 caps and min 2 small character
        Pattern p = Pattern.compile(regex);
        Matcher m = p.matcher(name);
        boolean r = m.matches();
        if (r)
